...
function fzy_common() {
    ...
    $("#serbtn").on("click",function(){
        switch ($("#sertxt").val()){
            case "贾梦云":
                //$(this).attr("href","贾梦云指南者/compass.html");
                window.open("贾梦云指南者/compass.html");
                return false;
                break;
            case "安呈豪":
                //$(this).attr("href","安呈豪jeep75th/index.html");
                window.open("安呈豪jeep75th/index.html");
                return false;
                break;
            case "尚永超":
                //$(this).attr("href","尚永超jeep大切诺基/index.html");
                window.open("尚永超jeep大切诺基/index.html");
                return false;
                break;
            case "魏晓悦":
                //$(this).attr("href","尚永超jeep大切诺基/index.html");
                window.open("魏晓悦jeep牧马人/jeep.html");
                return false;
                break;
            case "王雅超":
                //$(this).attr("href","尚永超jeep大切诺基/index.html");
                window.open("王雅超wyc_jeep自由侠/wyc_index.html");
                return false;
                break;
            default:
                //$(this).attr("href","#");
        ...
        $("body").on("keyup","#sertxt",function(event){
            if(event.keyCode==13){
                $("#serbtn").trigger("click");
            }
        })
}
